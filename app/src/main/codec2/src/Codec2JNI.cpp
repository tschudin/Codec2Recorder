...
namespace Java_nz_scuttlebutt_codec2recorder_tools_Codec2 {
...
using namespace Java_nz_scuttlebutt_codec2recorder_tools_Codec2;
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved) {
	...
	if (vm->GetEnv(reinterpret_cast<void**>(&env), JNI_VERSION_1_6) != JNI_OK) {
		...
		jclass clazz = env->FindClass("nz/scuttlebutt/codec2recorder/tools/Codec2");
		if (clazz) {
