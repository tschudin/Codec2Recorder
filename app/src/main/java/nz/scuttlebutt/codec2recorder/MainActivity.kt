...
import nz.scuttlebutt.codec2recorder.tools.PCMRecorder
import nz.scuttlebutt.codec2recorder.tools.Timer
import java.io.ByteArrayOutputStream


private const val PERMISSION_REQUEST = 789
private const val CHOOSEFILE_REQUEST = 987

class MainActivity : AppCompatActivity(), Timer.OnTimerUpdateListener {
